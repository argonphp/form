...
<head>
  ...
  <style type="text/css">
    nav.main-header a.nav-link span.badge {
      right: 0em;
    }
  </style>
  <?php Form::__styles() ?>
...
{{--
      ...
      <li class="nav-item dropdown">
        <a class="nav-link" data-toggle="dropdown" href="#">
          ...
          <span class="badge badge-danger navbar-badge">30</span>
        </a>
      ...
      <li class="nav-item dropdown">
        <a class="nav-link" data-toggle="dropdown" href="#">
          ...
          <span class="badge badge-warning navbar-badge">01</span>
        </a>
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
 ...
 --}}
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          @includeFirst(['sidebar', 'ArgonForm::layout.sidebar'])
